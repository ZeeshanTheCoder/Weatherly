 ...
 * @param {string} eventType Events Type e.g. "click", "mouseover"
  ...
  fetchData(url.currentWeather(lat, lon), (currentWeather) => {
    ...
    fetchData(url.airPollution(lat, lon), (airPollution) => {
      ...
      card.innerHTML = `
        ...
        module.aqiTexts[aqi].message
      }">
                                    ${module.aqiTexts[aqi].level}
                                </span>
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        windLi.innerHTML = `
                <div class="card card-sm slider-card">
                    ...
                    <img src="./assets/images/weather_icons/direction.png" width="48" height="48" loading="lazy" alt="direction" title="direction" class="weather-icon" style="transform: rotate(${
                      windDirection - 180
                    }deg)">
